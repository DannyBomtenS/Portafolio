...
$pdf->Cell(195, 5, utf8_decode("BOLETA"), 100, 10, 'C');
//
$pdf->Image("../../assets/img/icono.jpg", 175, 10, 38, 35, 'JPG');
$pdf->Cell(195, 5, utf8_decode(""), 0, 1, 'C');
$pdf->Cell(195, 5, utf8_decode(""), 0, 1, 'C');
//
$pdf->SetFont('Arial', 'B', 13);
$pdf->Cell(20, 5, utf8_decode("Nombre: "), 0, 0, 'L');
$pdf->SetFont('Arial', '', 13);
$pdf->Cell(27, 5, utf8_decode($datos['nombre']), 0, 1, 'C');
//
$pdf->SetFont('Arial', 'B', 13);
$pdf->Cell(20, 5, utf8_decode("Telefono: "), 0, 0, 'L');
$pdf->SetFont('Arial', '', 13);
$pdf->Cell(37, 5, utf8_decode($datos['telefono']), 0, 1, 'C');
//
$pdf->SetFont('Arial', 'B', 13);
$pdf->Cell(20, 5, utf8_decode("Direccion: "), 0, 0, 'L');
$pdf->SetFont('Arial', '', 13);
$pdf->Cell(48, 5, utf8_decode($datos['direccion']), 0, 1, 'C');
//
$pdf->SetFont('Arial', 'B', 13);
$pdf->Cell(20, 5, utf8_decode("Correo: "), 0, 0, 'L');
$pdf->SetFont('Arial', '', 13);
$pdf->Cell(53, 5, utf8_decode($datos['email']), 0, 1, 'C');
//
$pdf->SetFont('Arial', 'B', 13);
$pdf->Cell(20, 5, utf8_decode("Consultas: "), 0, 0, 'L');
$pdf->SetFont('Arial', '', 13);
$pdf->Cell(108, 5, utf8_decode("https://landcenter.com/consulta/M&C_STORE"), 100, 10, 'C');
$pdf->SetFont('Arial', 'B', 15);
$pdf->Cell(329, 5, utf8_decode("M&C STORE"), 100, 10, 'C');
//
$pdf->Ln();
